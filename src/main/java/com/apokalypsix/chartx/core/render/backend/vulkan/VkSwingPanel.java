...
/**
 * Swing panel that renders using Vulkan and displays the result.
 *
 * <p>This panel bridges Vulkan's offscreen rendering with Swing's
 * paint system by:
 * <ol>
 *   <li>Rendering to a Vulkan framebuffer</li>
 ...
 */
public class VkSwingPanel extends JPanel {

    private static final Logger log = LoggerFactory.getLogger(VkSwingPanel.class);
    ...
    private VkRenderCallback renderCallback;
     ...
     */
    @FunctionalInterface
    public interface VkRenderCallback {
        /**
         ...
         */
        void render(VkRenderDevice device, int width, int height);
    }

    public VkSwingPanel(VkRenderDevice device) {
        this.device = device;
        setOpaque(true);
     ...
     */
    public void setRenderCallback(VkRenderCallback callback) {
        this.renderCallback = callback;
    }

    /**
     * Requests a repaint of the Vulkan content.
     */
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!device.isInitialized()) {
            ...
            g.drawString("Vulkan not initialized", 10, 20);
            return;
        }
        ...
        try {
            ...
            log.error("Error during Vulkan render", e);
    ...
    private void resizeBuffers(int width, int height) {
        ...
        log.debug("Resized Vulkan buffers to {}x{}", width, height);
    }
     ...
     */
    public VkRenderDevice getDevice() {
        return device;
    }

    /**
     * Returns true if Vulkan is available and initialized.
     */
